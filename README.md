...
이 프로젝트는 **웹 기반 POS 시스템 POC**입니다:
- ✅ Next.js 웹 애플리케이션 (PC/태블릿/모바일 브라우저 지원)
- ✅ NICE 결제 API 연동 검증
- ✅ 결제/취소/조회 핵심 기능 구현
- ✅ RESTful API 설계로 향후 확장 가능

### 📱 향후 개발 계획

**모바일 앱 (React Native)** - 추가 개발 예정
- 태블릿/스마트폰 전용 POS 앱
- 생체 인증, 푸시 알림 등 네이티브 기능
- 오프라인 모드 지원
- 현재 API Routes를 그대로 사용하여 개발 가능
